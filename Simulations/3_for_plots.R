...
res <- read.csv(paste0("simulations/sim_", n, "_results.csv"), header=T, sep=",")
...
write.csv(results, "simulations/plot_lrs_penpow_adjpow.csv", row.names=FALSE)
...
write.csv(results2, "simulations/plot_rlrs.csv", row.names=FALSE)
