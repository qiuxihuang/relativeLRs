...
res <- read.csv(paste0("intermediate results/sim_", n, "_results.csv"), header=T, sep=",")
scenarios <- read.csv(paste0("intermediate results/table_scenarios.csv"), header=T, sep=",")
...
write.csv(results, "intermediate results/plot_lrs_penpow_adjpow.csv", row.names=FALSE)
...
write.csv(results2, "intermediate results/plot_rlrs.csv", row.names=FALSE)
