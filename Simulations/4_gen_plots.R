...
# read-in results
plotbase <- read.csv("intermediate results/plot_lrs_penpow_adjpow.csv",header=TRUE, sep=",")
...
setEPS()
postscript("output/figure2_rho0.eps",width=7.9,height=5.9)
print(f1)
dev.off()
...
setEPS()
postscript("output/figure3_rho06_pow.eps",width=7.9,height=5.9)
print(f1)
dev.off()
...
setEPS()
postscript("output/figure4_rho06_pen_pow.eps",width=7.9,height=5.9)
print(f1)
dev.off()
...
setEPS()
postscript("output/figure5_rho06_lr.eps",width=10.8,height=5.9)
grid.newpage()
...
# read-in results
plotbase2 <- read.csv("intermediate results/plot_rlrs.csv",header=TRUE, sep=",")
...
setEPS()
postscript("output/figure6_rho06_rlr.eps",width=10.8,height=5.9)
grid.newpage()
pushViewport(viewport(layout = grid.layout(1, 2)))
print(f1, vp = vplayout(1, 1))
print(f2, vp = vplayout(1, 2))
...
setEPS()
postscript("output/figure1_explore_lrs.eps",width=10.8,height=5.9)
